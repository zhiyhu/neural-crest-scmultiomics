...
conda activate /home/huzhiy/miniforge3/envs/chrombpnet_2024jan
...
mkdir -p ${wkdir}/data/10tfmodisco_2024jan/${cluster}

echo ${wkdir}/data/10tfmodisco_2024jan/${cluster}/modisco_results_allChroms_profile.hdf5

# modisco motifs -i ${h5py} -w 500 -n 50000 -v -o ${outdir}/modisco_results_profile.h5
modisco motifs -i ${wkdir}/data/09contribs_bw/${cluster}.profile_scores.h5 -n 50000 -v -o ${wkdir}/data/10tfmodisco_2024jan/${cluster}/modisco_results_allChroms_profile.hdf5 -w 500
# modisco motifs -i ${wkdir}/data/09contribs_bw/${cluster}.counts_scores.h5 -n 50000 -o $output_dir"/modisco_results_allChroms_counts.hdf5" -w 500
