...
saveRDS(colnames(seu) , "/t1-data/project/tsslab/zhu/multiome/analysis_newref/clustering/rds/subsetting_info/cellnames_multiome18k_NC.rds")
...
```{r}
write.csv(nc.markers, "/t1-data/project/tsslab/zhu/multiome/analysis_newref/clustering/results/NC_markers_RNAsoupx.csv")
saveRDS(seu, "/t1-data/project/tsslab/zhu/multiome/analysis_newref/clustering/rds/seuobj_rna/seu_RNAsoupx_NC.rds")
gc()
```
