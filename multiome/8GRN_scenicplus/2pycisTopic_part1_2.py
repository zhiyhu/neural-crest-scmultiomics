...
# import numpy as np
# np.where(pd.Series(dataset.list_attributes()['name']).str.contains('gene_id').tolist() )
# annot = dataset.query(attributes=['chromosome_name', 'transcription_start_site', 'strand', 
#         'external_gene_name', 'transcript_biotype','ensembl_gene_id'])
# annot.to_csv("/t1-data/project/tsslab/zhu/multiome/analysis_newref/GRN_scenicplus/data/gene_annot/pybiomart_drerio_gene_ensembl105.csv")
...
# s1: 4709 barcodes passed QC stats
# s2: 812 barcodes passed QC stats
# s3: 1833 barcodes passed QC stats
# s4: 1681 barcodes passed QC stats
# s5: 3385 barcodes passed QC stats
# s6: 3118 barcodes passed QC stats
# s7: 69 barcodes passed QC stats
# s8: 943 barcodes passed QC stats
# count total barcode number
...
# mNC_nohox               1267
# mNC_arch1               1140
# Pigment_sox6_high       1049
# Mutant_nohox_cycling    1039
# mNC_head_mesenchymal     958
# mNC_arch2                936
# Mutant_nohox_early       828
# mNC_hox34                796
# Mutant_nohox_12_22ss     663
# dNC_hoxa2b               642
# dNC_nohox_cycling        638
# Pigment_gch2_high        547
# NPB_nohox                539
# NPB_hox3                 527
# NPB_nohox_cycling        514
# Mutant_hox2              509
# Mutant_pigment           496
# NPB_hox2                 447
# Mutant_hox3              416
...
print(cistopic_obj)
# CCistopicObject from project cisTopic_merge with n_cells × n_regions = 16550 × 275579
