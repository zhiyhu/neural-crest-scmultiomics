...
seu <- readRDS("/ceph/project/tsslab/zhu/multiome/analysis_newref/clustering/rds/seuobj_rna/seu_RNAsoupx_NC.rds") # Clustered and annotated dataset for anterior NC (MUT+WT)
seu_atac <- readRDS("/ceph/project/tsslab/zhu/multiome/analysis_newref/preprocessing/rds/rna_atac_singlet/seuobj_atac64340.rds")
...
scplus_peaks <- read.table(
  file = "/ceph/project/tsslab/zhu/multiome/analysis_newref/GRN_scenicplus/ncall_2023oct_ccb/output/consensus_peak_calling/consensus_regions.bed",
...
saveRDS(macs2_counts, "/ceph/project/tsslab/zhu/multiome/analysis_newref/multivelo2023dec/data/02atac/counts_cistopicPeaks.rds")
...
seu[["ATAC"]]  <- NULL
saveRDS(seu, "/ceph/project/tsslab/zhu/multiome/analysis_newref/multivelo2023dec/data/02multiome/nc_multiome_forLinkPeaks.rds")
