"""
Compute images similarity: Gene based
Author: Zhiyuan, GPT4
Date: 20 Apr 2023
...
## manually download from https://storage.googleapis.com/tensorflow/keras-applications/vgg16/vgg16_weights_tf_dim_ordering_tf_kernels.h5
## upload to ~/.keras/models/
...
os.chdir("latent_time_grn/figures/image_similarity_gb")
...
def main():
    ...
    folder_path = 'latent_time_grn/figures/regulon_auc_gb_scatterplots/'
